...
export default function DoanloadNatalPdf() {
  ...
  const formCompoennt = findComponent("SOLAR_RETURN_CHART_FORM", components);
...
const pageSection = {
  id: 28,
  page_name: "Solar Return Payment Page",
  page_route: "solar-return-payment",
  page_skeleton: {
    page_name: "Solar Return Payment Page",
    page_id: "solar_return_payment",
    seo: {
      meta_title: "",
