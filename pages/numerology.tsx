...
const pageSection = [
  {
    ...
    variants: {
      ...
      NumerologyStyleTwo: {
        label: "Numerology With Image",
        value: "NumerologyStyleTwo",
        allowedComponents: ["HEADLINE", "CONTENT", "NUMEROLOGY_FORM", "IMAGE"],
      },
      NumerologyStyleThree: {
        label: "Split Numerology Section",
        value: "NumerologyStyleThree",
        allowedComponents: ["HEADLINE", "CONTENT", "NUMEROLOGY_FORM"],
      },
      NumerologyWithoutContent: {
        label: "Numerology Without Content",
        value: "NumerologyWithoutContent",
        allowedComponents: ["NUMEROLOGY_FORM"],
      },
    },
    currentVariant: "NumerologyWithoutContent",
    components: [
      {
        id: 1,
        type: "HEADLINE",
      ...
      {
        id: 4,
        type: "NUMEROLOGY_FORM_RESPONSE",
        label: "Numerology Response",
        props: {
          response_type: {
            input_type: "SELECT",
            value: "default",
