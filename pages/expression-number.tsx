...
const pageSection = [
  {
    type: "EXPRESSION_NUMBER_CALCULATOR",
    id: "expression-number-calculator",
    label: "Expression Number Calculator",
    config: {
      style: {
        type: "ExpressionNumberCalculatorWithoutContent",
        value: "",
      },
    },
    variants: {
      ...
      ExpressionNumberCalculatorStyleTwo: {
        label: "Expression Number Calculator With Image",
        value: "ExpressionNumberCalculatorStyleTwo",
        allowedComponents: [
          "HEADLINE",
          "CONTENT",
          "EXPRESSION_NUMBER_CALCULATOR_FORM",
      ...
      ExpressionNumberCalculatorStyleThree: {
        label: "Expression Number Section",
        value: "ExpressionNumberCalculatorStyleThree",
        allowedComponents: [
          "HEADLINE",
          "CONTENT",
          "EXPRESSION_NUMBER_CALCULATOR_FORM",
      ...
      ExpressionNumberCalculatorWithoutContent: {
        label: "Expression Number Calculator Without Content",
        value: "ExpressionNumberCalculatorWithoutContent",
        allowedComponents: ["EXPRESSION_NUMBER_CALCULATOR_FORM"],
      },
    },
    currentVariant: "ExpressionNumberCalculatorWithoutContent",
    components: [
      {
        id: 1,
        type: "HEADLINE",
      ...
      {
        id: 3,
        type: "EXPRESSION_NUMBER_CALCULATOR_FORM",
        label: "Expression Number Calculator Form",
        props: {
          button_text: {
      ...
      {
        id: 4,
        type: "EXPRESSION_NUMBER_CALCULATOR_FORM_RESPONSE",
        label: "Expression Number Calculator  Response",
        props: {
          response_type: {
            input_type: "SELECT",
            value: "default",
