...
const pageSection = [
  {
    ...
    config: {
      style: {
        type: "PersonalityNumberCalculatorStyleTwo",
        value: "",
      },
    },
    variants: {
      ...
      PersonalityNumberCalculatorStyleTwo: {
        label: "Personality Number Calculator With Image",
        value: "PersonalityNumberCalculatorStyleTwo",
        allowedComponents: [
          "HEADLINE",
          "CONTENT",
          "PERSONALITY_NUMBER_CALCULATOR_FORM",
      ...
      PersonalityNumberCalculatorStyleThree: {
        label: "Personality Number Section",
        value: "PersonalityNumberCalculatorStyleThree",
        allowedComponents: [
          "HEADLINE",
          "CONTENT",
          "PERSONALITY_NUMBER_CALCULATOR_FORM",
      ...
      PersonalityNumberCalculatorWithoutContent: {
        label: "Personality Number Calculator Without Content",
        value: "PersonalityNumberCalculatorWithoutContent",
        allowedComponents: ["PERSONALITY_NUMBER_CALCULATOR_FORM"],
      },
    },
    currentVariant: "PersonalityNumberCalculatorStyleTwo",
    components: [
      {
        id: 1,
        type: "HEADLINE",
      ...
      {
        id: 4,
        type: "PERSONALITY_NUMBER_CALCULATOR_FORM_RESPONSE",
