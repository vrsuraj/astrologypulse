...
export function ZodiacPartnerCompatibility({ data, handleCallback }) {
    ...
    <div className="max-w-5xl flex md:flex-row flex-col gap-24 items-start mx-auto">
      <div className="w-full flex flex-col gap-10 sm:gap-14">
        ...
        <button
          ...
          className="mr-auto bg-white px-10 py-2.5 rounded-md hover:bg-zinc-800 hover:text-white duration-100 ease-in"
        >
          Try again
        </button>
      </div>
