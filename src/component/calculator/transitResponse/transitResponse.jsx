...
export default function TransitResponse({ userData, handleForm }) {
  ...
  return (
    <>
      <div className="min-h-screen py-14 px-5 w-full">
...
-27 0 -31 -3 -28 -22z"
        ...
        {Object.keys(response).length > 0 && !loader ? (
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col gap-10 pt-5 md:pt-10 pb-10">
              <h4 className="md:text-3xl text-2xl border-b  border-secondary/50 pb-3 text-white">
                Daily Transit for{" "}
                {CallculatedateforTransit(response?.all?.transit_date)}
              </h4>

              <div className=" max-w-3xl mx-auto grid grid-cols-1 gap-20">
                {Array.isArray(response.short) && response.short.length > 0 && (
                  <div className="flex flex-col gap-5">
                    <h5 className="md:text-2xl text-xl font-cera_medium  pb-2 text-zinc-300">
                      Short Term Transit
                    </h5>
                    <div className="flex  flex-col divide-y divide-secondary/50 border-secondary/50 border">
                ...
                {Array.isArray(response.long) && response.long.length > 0 && (
