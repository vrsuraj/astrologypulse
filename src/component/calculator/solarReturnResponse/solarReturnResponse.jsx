...
export default function SolarReturnResponseFunc({
  userdata,
  handleForm,
  pageData,
}) {
  ...
  return (
    <div className="py-14 px-5">
      ...
      {Object.keys(userdata).length !== 0 && (
        <div className="py-10  mt-14 max-w-4xl mx-auto w-full border-t border-secondary/50">
          <ProfileDetailCard2
            userDetail={userdata}
            handleForm={() => handleForm("solar")}
          >
            <div className="pt-5 border-secondary/50  mt-2 border-t">
