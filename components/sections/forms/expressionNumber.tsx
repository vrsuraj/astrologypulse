...
export function getLayout(variant: string) {
  switch (variant) {
    case "expression_calculator_style_one":
    case "expression_calculator_style_two":
    case "expression_calculator_style_three":
    case "expression_calculator_style_four":
      return " md:flex-col justify-center text-center";

    case "expression_calculator_style_five":
      return "md:flex-row";
  }
}
