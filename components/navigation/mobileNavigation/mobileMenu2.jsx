    ...
    <>
      {transitions((style, i) => (
        <a.div
          ...
          style={style}
          ref={ref}
          className={`fixed   z-40 top-0 w-full max-w-lg right-0 bg-zinc-800 overflow-y-scroll h-full transition-all ease-in duration-[300ms]`}
        >
